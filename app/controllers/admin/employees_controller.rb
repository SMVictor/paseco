module Admin
  class EmployeesController < ApplicationController
    ...
    private
      ...
      def employee_params
        params.require(:employee).permit(:name, :identification, :account_owner, :account_identification, :id_type, :birthday, :gender, :ccss_number, :province, :canton, :district, :other, :phone, :phone_1, :emergency_contact, :emergency_number, :payment_method, :bank, :account, :social_security, :daily_viatical, :ccss_type, :special, :active, :retired, :registered_account, :email, :has_christmas_bonus, :own_ccss_deduction, sub_service_ids: [], stall_ids: [], position_ids: [], entries_attributes: [:id, :start_date, :end_date, :document, :reason_departure, :_destroy], vacations_attributes: [:id, :start_date, :end_date, :included_freedays, :requested_days, :period, :date,  :_destroy], disabilities_attributes: [:id, :start_date, :end_date, :institution, :document, :_destroy], movements_attributes: [:id, :start_date, :end_date, :affair, :type, :way, :amount, :comment, :_destroy])
      end
